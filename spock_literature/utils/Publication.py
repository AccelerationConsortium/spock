...
class Publication(BaseModel):
    ...
    """
    key:Optional[str] = Field(default=None, description="Unique identifier for the document")
    ...
    extra:Optional[List[Field]] = Field(default_factory=list, description="Additional fields for future extensions")
    ...
    @classmethod
    def from_text(cls, text: str, key: Optional[str] = None, **kwargs) -> "Publication":
        """
