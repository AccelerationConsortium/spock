...
for i in range(TIMES_BENCHMARK):
    ...
    logging.info(f'iteration {i} of llama3.1 using nvidia took {time() - start_time} seconds')
...
ax_hist_ollama.set_title("Histogram: Spock (llama3.1 8b 1 GPU) - summary task")
...
ax_hist_nvidia.set_title("Histogram: NVIDIA llama3.3 70b 1 GPU - summary task")
...
file_path = os.path.join(current_directory, f"comparison_plot_with_histograms_summary_llama3.1vs{TIMES_BENCHMARK}.png")
