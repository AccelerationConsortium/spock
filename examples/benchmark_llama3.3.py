...
import logging
logging.basicConfig(filename='/home/m/mehrad/brikiyou/scratch/spock/examples/experiment1.log', level=logging.INFO)
...
ax_hist_ollama.set_title("Histogram: Spock (llama3.3 70b 4 GPU)")
...
ax_hist_nvidia.set_title("Histogram: NVIDIA llama3.3 70b 4 GPU")
...
file_path = os.path.join(current_directory, f"comparison_plot_with_histograms_llama3.3_{TIMES_BENCHMARK}.png")
