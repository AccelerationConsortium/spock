...
ax_hist_ollama.set_title("Histogram: Spock (llama3.1 8b 1 GPU)")
...
ax_hist_nvidia.set_title("Histogram: Histogram: NVIDIA llama3.3 70b 1 GPU")
...
file_path = os.path.join(current_directory, f"comparison_plot_with_histograms_llama3.1vsss{TIMES_BENCHMARK}.png")
